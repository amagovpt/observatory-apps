...
export function GoodBadTab({ main_content_directory, columnsOptions, tableHeaders, table, goodOrBad }) {
  ...
  return (
    <section
      className={`bg-white ${main_content_directory} d-flex flex-row justify-content-center align-items-center`}
    >
